...
import { STATUSBAR_HEIGHT, SCREEN_WIDTH, searchType, BASE_URL } from '../../constants';
                        ...
                        {recentSearchings.map((searching, index) => (
                            <ExTouchableOpacity
                                ...
                                {searching.type === searchType.KEYWORD
                                    ...
                                    : <Image style={styles.avatar} source={{ uri: BASE_URL + (searching.user?.avatar_url || searching.page?.avatar_url || searching.group?.avatar_url ) }} />
                                }
