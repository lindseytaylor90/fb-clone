            ...
            <KeyboardAvoidingView style={styles.parentContainer} enabled behavior="height">
                <SafeAreaView style={styles.container}>
                    ...
                    <View style={styles.infoWrapper}>
                        <Image style={styles.avatar} source={{ uri: BASE_URL + user.avatar_url }}></Image>
                        <View>
                                        ...
                                        <View key={index}>
                                            {bgColor.isPureColor &&
                                                <TouchableWithoutFeedback style={styles.bgColor} onPress={this.onSelectBgColorHandler.bind(this, bgColor.id)}>
                                                    <View style={{ backgroundColor: bgColor.color, ...styles.bgImage, borderColor: this.state.selectedBgColorId === bgColor.id ? '#900c3f' : '#333', borderWidth: this.state.selectedBgColorId === bgColor.id ? 3 : 1 }}></View>
                                                </TouchableWithoutFeedback>
                                            }
                                            {!bgColor.isPureColor &&
                                                <TouchableWithoutFeedback style={styles.bgColor} onPress={this.onSelectBgColorHandler.bind(this, bgColor.id)}>
                                                    <Image style={{ ...styles.bgImage, borderColor: this.state.selectedBgColorId === bgColor.id ? '#900c3f' : '#333', borderWidth: this.state.selectedBgColorId === bgColor.id ? 3 : 1 }} source={{ uri: bgColor.bgImage_url }}></Image>
                                                </TouchableWithoutFeedback>
                                            }
