...
import { STATUSBAR_HEIGHT, SCREEN_WIDTH, SCREEN_HEIGHT, BASE_URL} from '../../constants';
                    ...
                    <View style={styles.infoWrapper}>
                        ...
                        <View style={styles.userInfoWrapper}>
                            ...
                            <View style={{
                                ...
                                <Image style={styles.avatar} source={{ uri: BASE_URL + item.user.avatar_url }} />
                                <Text style={{
                        ...
                        <View style={styles.relatedGroupsWrapper}>
                            ...
                            {item.relatedGroups.map((group, index) => (
                                <ExTouchableOpacity
                                    ...
                                    <Image style={styles.groupAvatar} source={{ uri: BASE_URL + group.avatar_url }} />
                                    <View style={{
