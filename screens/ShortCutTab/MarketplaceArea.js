            ...
            <View style={styles.container}>
                ...
                <View style={styles.areaOptionsWrapper}>
                    <TouchableOpacity
                        ...
                        <View style={{
                            ...styles.radioBtn,
                            borderColor: selectedOptionType === 1 ? '#900c3f' : '#333',
                        }}>
                            <View style={{
                                height: 12,
                                width: 12,
                                borderRadius: 12,
                                backgroundColor: selectedOptionType === 1 ? '#900c3f' : '#fff',
                            }}></View>
                        </View>
                    </TouchableOpacity>
                    <TouchableOpacity
                        ...
                        <View style={{
                            ...styles.radioBtn,
                            borderColor: selectedOptionType === 2 ? '#900c3f' : '#333',
                        }}>
                            <View style={{
                                height: 12,
                                width: 12,
                                borderRadius: 12,
                                backgroundColor: selectedOptionType === 2 ? '#900c3f' : '#fff',
                            }}></View>
                        </View>
                    </TouchableOpacity>
                            ...
                            >
                                <Animated.View activeOpacity={1}
                                    style={{
                                        ...
                                        backgroundColor: selectedOptionType === 1 ? '#333' : '#900c3f'
