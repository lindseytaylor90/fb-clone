                ...
                >
                    <View style={styles.categoryTitleWrapper}>
                        ...
                        <ExTouchableOpacity style={styles.btnHide}>
                            <FontAwesome5Icon name="map-marker-alt" color="#900c3f" size={16} />
                            <Text style={{ color: '#900c3f', marginLeft: 5, fontWeight: '500' }}>{user?.live_in}</Text>
                        </ExTouchableOpacity>
                        <View style={styles.filtersWrapper}>
                            <TouchableOpacity style={styles.btnFilter}>
                                <FontAwesome5Icon name="outdent" color="#900c3f" />
                                <Text style={{
                                    color: '#900c3f', marginLeft: 5,
                                    fontWeight: '600'
                                }}>Filter</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.btnFilter}>
                                <FontAwesome5Icon name="sort" color="#900c3f" />
                                <Text style={{
                                    color: '#900c3f', marginLeft: 5,
                                    fontWeight: '600'
                                }}>Sort</Text>
