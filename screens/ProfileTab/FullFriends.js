                ...
                <View style={styles.searchToolWrapper}>
                    <View style={styles.filterWrapper}>
                        <TouchableOpacity
                            ...
                            <Text style={{ fontSize: 16, fontWeight: '500', color: filterType === 1 ? "#900c3f" : '#000' }}>All</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={this.onPressToggleFilter.bind(this)}
                            activeOpacity={0.6}
                            style={{ ...styles.btnFilter, marginLeft: 10, backgroundColor: filterType === 2 ? '#9dd0eb' : '#ddd' }}>
                            <Text style={{ fontSize: 16, fontWeight: '500', color: filterType === 2 ? "#900c3f" : '#000' }}>Recent</Text>
                        </TouchableOpacity>
                    </View>
                                ...
                                <View key={index}>
                                    {
                                        friend.name.indexOf(keyword) > -1 ? (
                                            <ExTouchableOpacity onPress={this.onPressProfileHandler.bind(this, friend.id)} key={index} style={styles.friendItem}>
                                                <Image source={{ uri: BASE_URL + friend.avatar_url }} style={styles.friendAvatar} />
