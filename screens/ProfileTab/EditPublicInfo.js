...
import { SCREEN_HEIGHT, STATUSBAR_HEIGHT, BASE_URL } from '../../constants';
                ...
                <ScrollView bounces={false} style={styles.detailsWrapper}>
                    <View style={{ ...styles.detail, paddingTop: 0 }}>
                        <View style={styles.detailTitleWrapper}>
                            ...
                            <TouchableOpacity>
                                <Text style={{ fontSize: 16, color: "#900c3f" }}>Modify</Text>
                            </TouchableOpacity>
                        </View>
                        <TouchableOpacity activeOpacity={0.8}>
                            <Image source={{ uri: BASE_URL + userInfo.avatar_url }} style={styles.avatar}></Image>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.detail}>
                        <View style={styles.detailTitleWrapper}>
                            ...
                            <TouchableOpacity>
                                <Text style={{ fontSize: 16, color: "#900c3f" }}>Add</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    <View style={{ ...styles.detail }}>
                    ...
                    <View activeOpacity={0.9} style={{ ...styles.detail, ...styles.lastDetail }}>
                        <TouchableOpacity style={styles.btnModifyMore}>
                            <FontAwesome5Icon />
                            <Text style={{ color: '#900c3f', fontSize: 16, fontWeight: '500' }}>Modify introduction informations</Text>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
            </View>
