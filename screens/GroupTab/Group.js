...
import { SCREEN_HEIGHT, SCREEN_WIDTH, STATUSBAR_HEIGHT, BASE_URL } from '../../constants';
            ...
            <View style={styles.container}>
                <View style={{
                    ...
                    <Animated.View style={{ ...styles.groupTitle, opacity: groupTitleOpacity }}>
                        <Image style={{ ...styles.groupAvatar }} source={{ uri: BASE_URL + groupDetail.avatar_url }}></Image>
                        ...
                        <View style={styles.friendsInGroup}>
                            <ExTouchableOpacity style={styles.friendAvatarsWrapper}>
                                {friendsInGroup.map((friend, index) => (
                                    <ImageBackground key={index} source={{ uri: BASE_URL + friend.avatar_url }}
