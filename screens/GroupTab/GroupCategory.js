...
import { STATUSBAR_HEIGHT, BASE_URL } from '../../constants';
        ...
        return (
            <View style={styles.container}>
                ...
                <ScrollView scrollEventThrottle={30} bounces={false} onScroll={this.onScrollHandler.bind(this)} >
                    <ImageBackground imageStyle={styles.coverImage} style={styles.cover} source={{ uri: BASE_URL + category.avatar_url }}>
