...
import { STATUSBAR_HEIGHT, SCREEN_WIDTH, pageNavigationTypes, BASE_URL } from '../../constants';
                    ...
                    <View style={{
                        ...
                        <ScrollView
                            ...
                            <TouchableOpacity onPress={this.onPressChangeTabHandler.bind(this, pageNavigationTypes.HOME)} style={{
                                ...
                                <Text style={{
                                    color: currentNavigationTab === pageNavigationTypes.HOME ? '#900c3f' : 'gray',
                                    fontWeight: '600'
                                }}>Home</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={this.onPressChangeTabHandler.bind(this, pageNavigationTypes.INTRODUCTION)} style={{
                                ...
                                <Text style={{
                                    color: currentNavigationTab === pageNavigationTypes.INTRODUCTION ? '#900c3f' : 'gray',
                                    fontWeight: '600'
                                }}>About</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={this.onPressChangeTabHandler.bind(this, pageNavigationTypes.POSTS)} style={{
                                ...
                                <Text style={{
                                    color: currentNavigationTab === pageNavigationTypes.POSTS ? '#900c3f' : 'gray',
                                    fontWeight: '600'
                                }}>Posts</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={this.onPressChangeTabHandler.bind(this, pageNavigationTypes.VIDEOS)} style={{
                                ...
                                <Text style={{
                                    color: currentNavigationTab === pageNavigationTypes.VIDEOS ? '#900c3f' : 'gray',
                                    fontWeight: '600'
                                }}>Videos</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={this.onPressChangeTabHandler.bind(this, pageNavigationTypes.PHOTOS)} style={{
                                ...
                                <Text style={{
                                    color: currentNavigationTab === pageNavigationTypes.PHOTOS ? '#900c3f' : 'gray',
                                    fontWeight: '600'
                                }}>Photos</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={this.onPressChangeTabHandler.bind(this, pageNavigationTypes.EVENT)} style={{
                                ...
                                <Text style={{
                                    color: currentNavigationTab === pageNavigationTypes.EVENT ? '#900c3f' : 'gray',
                                    fontWeight: '600'
                                }}>Events</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={this.onPressChangeTabHandler.bind(this, pageNavigationTypes.COMMUNICATION)} style={{
                                ...
                                <Text style={{
                                    color: currentNavigationTab === pageNavigationTypes.COMMUNICATION ? '#900c3f' : 'gray',
                                    fontWeight: '600'
                                }}>Community</Text>
                            </TouchableOpacity>
                        </ScrollView>
                    ...
                    <View style={styles.wrapper}>
                        ...
                        <View style={styles.Info}>
                            <View style={styles.mainInfo}>
                                <Image source={{ uri: BASE_URL + pageDetail.avatar_url }} style={styles.avatar} />
                                ...
                                <TouchableOpacity style={styles.btnLike} >
                                    <FontAwesome5Icon name="thumbs-up" size={24} color="#900c3f" />
                                    <Text></Text>
                                </TouchableOpacity>
                            </View>
                            ...
                            <View style={styles.friendsLikePage}>
                                <View style={styles.friendAvatarsWrapper}>
                                    {friendsLikePage.splice(0, 3).map((friend, index) => (
                                        <Image
                                            source={{ uri: BASE_URL + friend.avatar_url }}
                                            key={index}
                                            style={{
                                                ...styles.friendAvatar,
