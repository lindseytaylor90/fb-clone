...
import { SCREEN_WIDTH, SCREEN_HEIGHT, permission, BASE_URL } from '../../constants';
        ...
        return (
            <View
                ...
                <View style={styles.infoListItem}>
                    <Image style={styles.pageAvatar} source={{ uri: BASE_URL + video.page.avatar_url }} />
                    <View style={styles.centerInfoWrapper}>
                        <View style={styles.centerInfoUp}>
                            <TouchableOpacity>
                                <Text style={styles.name}>{video.page.name}</Text>
                            </TouchableOpacity>
                            <Text style={{ color: '#900c3f' }}> • </Text>
                            <TouchableOpacity>
                                <Text style={{ color: '#900c3f' }}>Follow</Text>
                            </TouchableOpacity>
                        </View>
                    ...
                    <View style={styles.reactionValueWrapper}>
                        <TouchableOpacity >
                            <View style={styles.reactionNumberWrapper}>
                                <FontAwesome5Icon name="thumbs-up" color="#900c3f" size={14}>
                                </FontAwesome5Icon>
                    ...
                    <View style={styles.btnReactionWrapper}>
                        <TouchableOpacity style={styles.btnWrapper} >
                            <View style={styles.reactionBtn}>
                                <FontAwesome5Icon name="thumbs-up" color={'#900c3f'} size={20}>
                                </FontAwesome5Icon>
